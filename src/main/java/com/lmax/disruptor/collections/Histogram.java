...
public final class Histogram
{
    ...
    public boolean addObservation(final long value)
    {
        ...
        // do a classic binary ch5_search to find the high value
        while (low < high)
        {
        ...
        // if the binary ch5_search found an eligible bucket, increment
    ...
    public long getUpperBoundForFactor(final double factor)
    {
        ...
        // reverse ch5_search the intervals ('tailCount' from end)
